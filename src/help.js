...
> * Outros comandos * <
comando: * $ {prefix} tp *
desc: Criador de texto / logotipo do textpro.me
uso: * $ {prefix} tp [no] [texto] * \ nexemplo: * $ {prefix} tp 1 YourText *
nota: * $ {prefix} lista tp * (para mostrar todos os temas) \ n
comando: * $ {prefix} ep *
desc: Text / Logo maker de ephoto360.com
uso: * $ {prefix} ep [no] [text] * \ nexemplo: * $ {prefix} ep 1 YourText *
nota: * $ {prefix} lista de ep * (para mostrar todos os temas) \ n
comando: * $ {prefix} tahta *
desc: Harta Tahta .....
uso: * $ {prefix} tahta [texto] * \ nexemplo: * $ {prefix} tahta SeuTexto * \ n
comando: * $ {prefix} gtts *
